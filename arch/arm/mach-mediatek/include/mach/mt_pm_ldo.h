...
/******************************************************************************/
/*OPPO zhangkw add start 2013-02-19*/
#ifdef VENDOR_EDIT
extern bool hwPowerOnPre(MT65XX_POWER powerId, MT65XX_POWER_VOLTAGE powerVolt, char *mode_name);
extern bool hwPowerOnRealEnable(MT65XX_POWER powerId);
extern bool hwPowerDownPre(MT65XX_POWER powerId, char *mode_name);
extern bool hwPowerDownRealDisable(MT65XX_POWER powerId);
#endif
/*OPPO zhangkw add end 2013-02-19*/
/******************************************************************************/
