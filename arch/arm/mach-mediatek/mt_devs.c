...
signed int g_true_vol=0;
signed int g_charger_type=0;
#endif
...
#ifdef VENDOR_EDIT
//LiuBin@MtkCamera, 2012/09/20, Add for spi driver of MS2R
...
#ifdef VENDOR_EDIT
//yongjun.wu@Pro.drv.BL,2013/05/07,add backlight
static struct platform_device lm3528_pdev = {
	.name	= "lm3528-platform",
	.id	= -1,
};
#endif
/*=======================================================================*/
...
#endif
#ifdef VENDOR_EDIT
/* hanbin.lin@BasicDrv.Audio, 2013/2/4, Add for audio */

struct platform_device headset_pa_dev = {
	.name	       = "HeadsetPA_TS4621",
	.id            = -1,
};
#endif
//////////////////////////////
...
/*=======================================================================*/
#ifndef VENDOR_EDIT
#rendong.shi@Basic.drv, 2012/12/12, Add for 12083 TP
static struct platform_device mtk_tpd_dev = {
    .name = "mtk-tpd",
    .id   = -1,
};
#else /* VENDOR_EDIT */
static struct platform_device synaptics_dev = {
    .name = "synaptics-platform",
    .id   = -1,
};
static struct platform_device synaptics_dev_black = {
    .name = "synaptics-platform-black",
    .id   = -1,
};

static struct platform_device micro_dev = {
    .name = "micro-platform",
    .id   = -1,
};
...
#ifdef OPPO_WOLFSON_CODEC_SUPPORT
static struct platform_device extern_codec_dev = {
    .name = "ExternCodec",
    .id   = -1,
};
#endif
...
/* FIXME: need porting */
    ...
    for (; tags->hdr.size; tags = tag_next(tags)) {
        ...
        {
            g_true_vol = tags->u.battery_vol.battery_vol;
            g_charger_type = tags->u.battery_vol.charger_type;
        }
#endif
#ifdef VENDOR_EDIT
		//yongjun.wu@BasicDrv.LCD, 2013/03/14, Add for lcd adapt[LCD_UBOOT_KERNEL]
		else if(tags->hdr.tag == ATAG_LCD_ID_VALUE3)
			{
				g_lcd_id_value3 =tags->u.lcd_id.lcd_id;
			    printk("g_lcd_id_value3=%d,\n",g_lcd_id_value3);
			}
#endif /* VENDOR_EDIT */
    }
...
/*=======================================================================*/
#ifdef VENDOR_EDIT//zhye add for muti gsensor
#if 0
struct platform_device sensor_gsensor_mma8453q = {
	.name	       = "gsensor_mma8453q",
	.id            = -1,
};

struct platform_device sensor_gsensor_lis3dh = {
	.name	       = "gsensor_lis3dh",
	.id            = -1,
};
#endif
struct platform_device sensor_gsensor_adxl346 = {
...
#endif /*VENDOR_EDIT*/
#ifndef VENDOR_EDIT
//xiaohua.tian@wxkf.wxBasicDriver.Sensor,2013/03/01,add mmc3416x
struct platform_device sensor_msensor = {
	.name	       = "msensor",
	.id            = -1,
};
#else
struct platform_device sensor_msensor_mmc328x = {
	.name	       = "msensor_mmc328x",
	.id            = -1,
	};
struct platform_device sensor_msensor_mmc3416x = {
...
#ifdef VENDOR_EDIT  //xiaohua.tian@wxkf.wxBasicDriver.sensor,2013/03/04,modify alsps sensor
struct platform_device sensor_alsps_stk31xx = {
	.name	       = "als_ps_stk31xx",
	.id            = -1,
};

struct platform_device sensor_alsps_tmd2771 = {
	.name	       = "als_ps_tmd2771",
	.id            = -1,
};  
#else /*VENDOR_EDIT*/
...
struct platform_device sensor_gyroscope_mpu6050c = {
	.name	       = "gyroscope_mpu6050c",
	.id            = -1,
};
struct platform_device sensor_gyroscope_l3gd20 = {
	.name	       = "gyroscope_l3gd20",
	.id            = -1,
};
...
#ifdef VENDOR_EDIT
//yongjun.wu@Pro.drv.BL 2013/05/07,add backlight
	retval = platform_device_register(&lm3528_pdev);
	if (retval != 0) {
		return retval;
	}
#endif
...
"\n",   bl_fb.base, bl_fb.size, FB_START, FB_SIZE);
  ...
  if(retval != 0)
  {
    ...
    #ifdef VENDOR_EDIT//zhye add  for 13009 gsensor
	retval = platform_device_register(&sensor_gsensor_adxl346);
			printk("sensor_gsensor_adxl346 device!\n");
		if (retval != 0)
			return retval;
		retval = platform_device_register(&sensor_gsensor_lis3dh);
			printk("sensor_gsensor_lis3dh device!\n");
		if (retval != 0)
			return retval;
	#else
    ...
    #ifdef VENDOR_EDIT//xiaohua.tian add for  12093 msensor

  	retval = platform_device_register(&sensor_msensor_mmc3416x);
		printk("sensor_msensor_mmc3416x device!");
	if (retval != 0)
		return retval;
	retval = platform_device_register(&sensor_msensor_mmc328x);
		printk("sensor_msensor_mmc328x  device! retval=%d\n",retval);
	if (retval != 0)
		return retval;
    #else /*VENDOR_EDIT*/
	...
	retval = platform_device_register(&sensor_gyroscope_mpu6050c);
		printk("sensor_gyroscope device!");
	if (retval != 0)
		return retval;

	retval = platform_device_register(&sensor_gyroscope_l3gd20);
		printk("sensor_gyroscope device!");
	if (retval != 0)
		return retval;
#endif
    ...
    #ifdef VENDOR_EDIT //xiaohua.tian@wxkf.wxBasicDriver.sensor,2013/03/04,modify alsps sensor
	 retval = platform_device_register(&sensor_alsps_stk31xx);
        printk("sensor_alsps_stk31xx device!");
        if (retval != 0)
            return retval;
	 retval = platform_device_register(&sensor_alsps_tmd2771);
        printk("sensor_alsps_tmd2771 device!\n");
        if (retval != 0)
            return retval;
    #else /*VENDOR_EDIT*/
...
#ifndef VENDOR_EDIT
#rendong.shi@Basic.drv, 2012/12/12, Add for 12015 TP
...
#endif
#else  /* VENDOR_EDIT */
	retval = platform_device_register(&synaptics_dev);
    if (retval != 0) {
        return retval;
    }
	retval = platform_device_register(&synaptics_dev_black);
    if (retval != 0) {
        return retval;
    }
   retval = platform_device_register(&micro_dev);
    if (retval != 0) {
        return retval;
    }   
#endif
...
/* xiang.fei@BasicDrv.Audio, 2012/12/22, Add for audio */
#ifdef OPPO_WOLFSON_CODEC_SUPPORT
    retval = platform_device_register(&extern_codec_dev);
    if(retval != 0)
    {
        printk("failed to register extern codec device\n");
        return retval;
    }
#endif
#endif /* VENDOR_EDIT */
#ifdef VENDOR_EDIT
/* hanbin.lin@BasicDrv.Audio, 2013/2/4, Add for audio */
retval = platform_device_register(&headset_pa_dev);
	if (retval != 0){
		printk("register headset device fail!\n");
		return retval;
	}
	else
	{
	    printk("register headset device success!!!!!!\n");
	}
#endif
    /////////////////////////////////
